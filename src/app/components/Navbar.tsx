import { Menu, ChevronDown, Bell, Settings, User, LogOut, Sun, Moon, Search, Key, GraduationCap, ChevronLeft, Maximize, Minimize } from "lucide-react";
...
export function Navbar() {
  ...
  const { activePage, setActivePage, showNotifications, setShowNotifications } = useNavigation();
      ...
      >
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 md:gap-3">
            ...
            <div className="relative" ref={profileMenuRef}>
              <button
                ...
                style={{
                  backgroundColor: showProfileMenu ? `${colors.primary}11` : 'transparent'
                }}
                onMouseEnter={(e) => {
                  if (!showProfileMenu) {
              ...
              >
                ...
                >
                  <span className="text-base md:text-lg font-bold" style={{ color: colors.primary }}>م</span>
                </div>
              </button>
                  ...
                  >
                    ...
                    >
                      <div className="flex items-center gap-4">
                        ...
                        >
                          <span className="text-3xl font-bold" style={{ color: colors.primary }}>م</span>
                        </div>
                        <div className="flex-1">
                          <p className="text-base font-bold mb-1" style={{ color: colors.textPrimary }}>
                            مهندس میرحسینی
                          </p>
                    ...
                    <div className="p-2">
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-2">
                            <Key className="w-4 h-4" style={{ color: colors.textSecondary }} />
                      ...
                      {/* Divider */}
                      <div className="h-px mx-2 my-2" style={{ backgroundColor: colors.border }}></div>
                      ...
                      >
                        ...
                        <div className="flex-1 text-right">
                          <span className="text-sm font-bold block" style={{ color: colors.error }}>
                            خروج از حساب
                          </span>
                          <span className="text-xs" style={{ color: colors.textSecondary }}>
                            خروج از سیستم بینش
            ...
            >
              ...
              <span 
                ...
                style={{ 
                  background: 'linear-gradient(to bottom right, #ff3b3b, #e92c2c)',
            ...
            >
              {isDarkMode ? (
                ...
                <Moon className="w-5 h-5 group-hover:rotate-12 transition-transform duration-300" style={{ color: colors.textPrimary }} />
              )}
            </button>
            ...
            >
              {isFullscreen ? (
                <Minimize className="w-5 h-5 group-hover:scale-90 transition-transform duration-300" style={{ color: colors.textPrimary }} />
              ) : (
                <Maximize className="w-5 h-5 group-hover:scale-110 transition-transform duration-300" style={{ color: colors.textPrimary }} />
              )}
            </button>
          </div>
          ...
          <div className="hidden md:flex flex-1 max-w-md mx-8">
            ...
            >
              <Search className="w-4.5 h-4.5" style={{ color: colors.textSecondary }} />
              <input
                type="text"
          ...
          <div className="flex items-center gap-3">
            ...
            {activePage !== "dashboard" && (
              <>             
                ...
                <div className="relative" ref={pagesMenuRef}>
                  ...
                  >
                    <span className="text-sm text-[#1c1c1c] dark:text-white">{pageNames[activePage as PageType]}</span>
                  </button>

                  {/* Pages Dropdown Menu */}
                  {showPagesMenu && (
                    <div className="absolute top-full right-0 mt-2 w-[200px] bg-white dark:bg-[#1a1f2e] rounded-lg border border-[#e8e8e8] dark:border-[#2a3142] shadow-xl overflow-hidden z-50 animate-fadeIn" dir="rtl">
                      <div className="py-1">
                        <button
                          onClick={() => {
                            setActivePage("dashboard");
            ...
            <div className="relative" ref={appsMenuRef}>
              ...
              >
                <p className="text-white text-sm font-black uppercase">مدیریت داده‌ها</p>
              </button>
